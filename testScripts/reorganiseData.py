          ...
          for y in range(0,280,1):
            if(validityCheck(x,y) != 'NA' ):
                if(validityCheck(x,y)=='0'):
                    ...
                    cv.imwrite("C:/Users/gulat/Desktop/thesis/gitThesis/images/organisedImages/trainBad/img"+str(bNo)+".png",img)
                    bNo = bNo + 1
                elif((validityCheck(x,y))=='1'):
                    img = cv.imread("C:/Users/gulat/Desktop/thesis/gitThesis/images/postProcessedImage/degree"+str(z)+"/plate"+str(x)+"/img"+str(y)+".png")
                    img = cv.cvtColor(img, cv.COLOR_BGR2GRAY)
                    cv.imwrite("C:/Users/gulat/Desktop/thesis/gitThesis/images/organisedImages/trainGood/img"+str(gNo)+".png",img)
                    gNo = gNo + 1
